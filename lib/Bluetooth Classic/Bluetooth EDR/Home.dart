...
class HomePageEDR extends StatefulWidget {
  @override
  _HomePageEDRState createState() => _HomePageEDRState();
}

class _HomePageEDRState extends State<HomePageEDR> with WidgetsBindingObserver {
